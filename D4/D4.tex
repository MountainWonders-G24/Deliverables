...
Segue poi il modello della montagna.
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth] {D4/img/mountain_model.png}
    \caption{Logout api diagram}
    \end{figure}
...
L'ultimo modello dell'applicazione è quello che rappresenta i rifugi.
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth] {D4/img/refuge_model.png}
    \caption{Logout api diagram}
    \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth] {D4/img/test_folders.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth] {D4/img/login_testing.png}
